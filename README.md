...
- **RESTful API**: Created [a custom RESTful API server'](https://github.com/AntonovAtanas/RestfulAPI-for-Screenia) using Node.js, Express.js, MongoDB with Mongoose, Bcrypt and JsonWebtoken to handle server-side functionalities and backend operations.
